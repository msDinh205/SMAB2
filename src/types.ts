...
export interface Violation {
  type: 'classroom' | 'room' | 'dining' | 'hygiene' | 'heavy5' | 'heavy10';
  description: string;
  count: number;
}
...
export const EDUCATIONAL_SOLUTIONS: Record<Violation['type'], string> = {
  ...
  hygiene: 'Nhắc nhở toàn lớp về ý thức giữ gìn vệ sinh chung. Phân công tổ trực nhật làm lại và kiểm tra chéo giữa các tổ. Nếu vi phạm nặng, yêu cầu học sinh vi phạm tổng vệ sinh khu vực được phân công vào cuối tuần.',
